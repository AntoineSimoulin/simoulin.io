import{L as f}from"./B0GJjto5.js";import{f as x,p as w}from"./ArINHTJU.js";import{_ as b,c as r,a as e,f as _,n as l,t as s,b as y,r as v,o as i,d,F as k,g as A,h as S}from"./EW_9uJnI.js";const L={props:["citation","index"],components:{LinkIcon:f},computed:{isWide(){return this.index%4===0},badgeColorClass(){const t=["bg-yellow-300","bg-pink-300","bg-purple-300","bg-blue-300","bg-emerald-300"];return t[this.index%t.length]},btnColorClass(){const t=["bg-yellow-300 hover:bg-yellow-400","bg-pink-300 hover:bg-pink-400","bg-purple-300 hover:bg-purple-400","bg-blue-300 hover:bg-blue-400","bg-emerald-300 hover:bg-emerald-400"];return t[this.index%t.length]}},methods:{formatMonth:x,getCleanUrl(t){return t.replace(/(^\w+:|^)\/\/(?:www\.)?/,"").split("/")[0]}}},q={class:"w-full bg-white border-2 border-black hover:-translate-y-0.5 hover:shadow-[3px_3px_0px_#000] transition-all duration-200 rounded-2xl p-6 flex flex-col justify-between h-full"},C={class:"flex items-center justify-between gap-2 mb-3"},N=["href"],P={key:0,class:"text-black/80 text-sm font-medium leading-relaxed my-3"},j={class:"pt-4 flex items-center"},B=["href"];function T(t,a,n,h,u,o){const c=v("LinkIcon");return i(),r("div",{class:l(["flex",o.isWide?"col-span-1 md:col-span-2 lg:col-span-2":"col-span-1"])},[e("div",q,[e("div",null,[e("div",C,[e("span",{class:l(["text-black border-2 border-black px-3 py-1 rounded-xl text-xs font-black shadow-[1.5px_1.5px_0px_#000]",o.badgeColorClass])},s(o.formatMonth(n.citation.fields.month))+" "+s(n.citation.fields.year),3)]),e("a",{target:"_blank",href:n.citation.fields.url,class:"no-underline text-black hover:text-blue-600"},[e("h2",{class:l(["font-black tracking-tight leading-snug mb-3",o.isWide?"text-2xl lg:text-3xl":"text-xl"])},s(n.citation.fields.title),3)],8,N),"abstract"in n.citation.fields?(i(),r("p",P,s(n.citation.fields.abstract),1)):_("",!0)]),e("div",j,[e("a",{href:n.citation.fields.url,target:"_blank",class:l(["inline-flex items-center gap-1.5 text-black border-2 border-black shadow-[1.5px_1.5px_0px_#000] active:translate-x-0.5 active:translate-y-0.5 px-3 py-1.5 rounded-xl font-black text-xs transition-all no-underline",o.btnColorClass])},[y(c,{class:"w-3.5 h-3.5 fill-current text-black"}),e("span",null,s(o.getCleanUrl(n.citation.fields.url)),1)],10,B)])])],2)}const p=Object.assign(b(L,[["render",T]]),{__name:"BlogPost"}),I=`% String.raw\`\`
@misc{Simoulin22,
...
`,E={components:{BlogPost:p},data(){return{blogPosts:I}},methods:{getBibEntries(t){return w(t)}},created(){this.blogPosts=this.getBibEntries(this.blogPosts)}},M={class:"pb-0 lg:py-6"},D={class:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 grid-flow-dense mb-8"};function J(t,a,n,h,u,o){const c=p;return i(),r("section",M,[e("div",null,[a[0]||(a[0]=e("div",{class:"w-full mb-6"},[e("h1",{class:"font-extrabold text-4xl pb-3 text-black tracking-tight"},[d(" Articles & thoughts on "),e("mark",{class:"bg-purple-100 text-black px-2.5 py-0.5 border-2 border-black rounded-xl inline-block rotate-1"},"AI, NLP & Tech"),d(". ")])],-1)),e("div",D,[(i(!0),r(k,null,A(u.blogPosts.entries,(m,g)=>(i(),S(c,{key:m.id,citation:m,index:g},null,8,["citation","index"]))),128))])])])}const G=b(E,[["render",J]]);export{G as default};
