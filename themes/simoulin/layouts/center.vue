...
<template>
  <div class="slidev-layout center w-full h-full flex flex-col justify-center items-center p-8 bg-white" :style="{ '--chapter-no': info.chapter, '--slide-no': info.relativeSlide }">
