...
<template>
  ...
  >
    <figure class="flex-1 flex flex-col overflow-hidden">
      ...
      <figcaption class="text-left text-xs font-medium text-black leading-snug bg-yellow-100/80 border-t-2 border-black px-3.5 py-2.5 w-full mt-auto shrink-0 flex items-baseline gap-2">
        <span v-if="label" class="font-black bg-yellow-300 text-black border border-black shadow-[1px_1px_0px_#000] px-2 py-1 rounded-md shrink-0 inline-flex items-center leading-none select-none">{{ label }}</span>
