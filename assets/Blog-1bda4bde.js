import{L as g}from"./iconLink-c99f8c3b.js";import{_ as c,r as u,o as n,c as o,a as t,t as e,g as f,b as l,h as r,i as _,F as y,e as w,f as x}from"./index-0a48d653.js";const v={props:["citation"],components:{LinkIcon:g},methods:{getCleanUrl(s){return s.replace(/(^\w+:|^)\/\/(?:www\.)?/,"").split("/")[0]}}},A={key:0,class:"col-md-6 col-lg-4 d-flex aos-init aos-animate article","data-aos":"fade-up","data-aos-delay":"400"},S={class:"card mb-3 shadow border-0 rounded-2"},q=["href"],L=["src"],N={class:"card-body d-flex flex-column"},P={class:"d-flex justify-content-between mb-3"},k={class:"text-small d-flex"},j={class:"text-muted"},B={class:"text-decoration-none",target:"_blank",href:"https://huggingface.co/blog/1b-sentence-embeddings"},C={class:"text-dark"},$={key:0,class:"flex-grow-1"},T={class:"text-small opacity-70"},I={key:1,class:"col-md-6 col-lg-4 d-flex aos-init aos-animate article","data-aos":"fade-up","data-aos-delay":"400"},E=["href"],M={class:"d-flex justify-content-between mb-3"},D={class:"text-small d-flex"},J={class:"opacity-70"},U={class:"text-small opacity-70"};function V(s,a,d,m,h,p){const i=u("LinkIcon");return"thumbnail"in this.citation.fields?(n(),o("div",A,[t("div",S,[t("a",{target:"_blank",href:this.citation.fields.url},[t("img",{src:this.citation.fields.thumbnail[0],alt:"Image",class:"card-img-top"},null,8,L)],8,q),t("div",N,[t("div",P,[t("div",k,[t("span",j,e(this.citation.fields.month[0])+" "+e(this.citation.fields.year[0]),1)])]),t("a",B,[t("h4",C,e(this.citation.fields.title[0]),1)]),"abstract"in this.citation.fields?(n(),o("p",$,e(this.citation.fields.abstract[0]),1)):f("",!0),t("div",null,[l(i),r(),t("span",T,e(this.getCleanUrl(this.citation.fields.url[0])),1)])])])])):(n(),o("div",I,[t("a",{target:"_blank",href:this.citation.fields.url,class:"text-decoration-none card card-body justify-content-between bg-primary text-light mb-3 shadow border-0 rounded-2"},[t("div",M,[t("div",D,[t("span",J,e(this.citation.fields.month[0])+" "+e(this.citation.fields.year[0]),1)])]),t("div",null,[t("h2",null,e(this.citation.fields.title[0]),1),l(i,{fill:"white"}),r(),t("span",U,e(this.getCleanUrl(this.citation.fields.url[0])),1)])],8,E)]))}const F=c(v,[["render",V]]),G=`% String.raw\`\`
@misc{Simoulin22,
