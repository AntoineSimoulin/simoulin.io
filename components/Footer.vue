...
import DblpIcon from "./icons/iconDblp.vue";
import AclIcon from "./icons/iconAcl.vue";
import HuggingFaceIcon from "./icons/iconHuggingFace.vue";
...
<style scoped>
/* Removed specific hover styles as we use Tailwind utility classes now */
</style>